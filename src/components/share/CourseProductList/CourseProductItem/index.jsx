...
function CourseProductItem() {
  return (
    <Popover placement="right" content={content}>
      <Link to={"/course-info/1"} className={styles.course_product_list__item}>
        <img
          src="https://img-c.udemycdn.com/course/100x100/823546_a941.jpg"
          alt="avatar course"
          className={styles.course_product_list__item__img_course}
        />
        <div className={styles.course_product_list__item__content}>
          <strong
            className={styles.course_product_list__item__content__name_course}>
            C++ từ cơ bản tới nâng cao dành cho người mới học lập trình
          </strong>
          <strong className={styles.course_product_list__item__content__author}>
            Le Tran Dat
          </strong>
          <div className={styles.course_product_list__item__content__review}>
            <span
              className={
                styles.course_product_list__item__content__review__rate
              }>
              4,4
            </span>
            <Rate
              className={
                styles.course_product_list__item__content__review__icon
              }
              allowHalf
              defaultValue={5}
              disabled
            ...
            <span
              className={
                styles.course_product_list__item__content__review__preson
              }>
              (41)
            </span>
          </div>
          <div
            className={styles.course_product_list__item__content__price}></div>
