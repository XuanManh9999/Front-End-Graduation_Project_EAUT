    ...
    return (
        <Popover placement="right" content={content} >
            <div className={styles.carousel__item} >
                <img src="https://img-c.udemycdn.com/course/480x270/6291743_5d97_3.jpg" alt="name_course" className={styles.carousel__item__img_course} />
                <h5 className={styles.carousel__item__title}>Spring Boot Full Skill's </h5>
                ...
                <div className={styles.carousel__item__star}>
                    ...
                    <Rate className={styles.carousel__item__star__icon_rate} allowHalf defaultValue={5} disabled />
                    <span className={styles.carousel__item__star_rate__presion_review}>(41)</span>
                </div>
                <div className={styles.carousel__item__price}>
                    <strong className={styles.carousel__item__price__discount}>1.099.000 ₫</strong>
                    <strong className={styles.carousel__item__price_now}>1.099.000 ₫</strong>
                </div>
